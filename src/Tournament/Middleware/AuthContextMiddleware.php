 ...
 * The authorization context is also filled with attributes gained from RouteArgsResolver,
 * so this middleware shall be executed after both authentication and route args resolving
 */
