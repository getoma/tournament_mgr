...
final class AuthContext
{
   ...
   /* an actual user */
   static public function user(User $user, ?Tournament $tournament, ?Area $area): static
   {
      return new static(authtype: AuthType::USER, user: $user, tournament: $tournament, area: $area);
   }

   /* device account */
   static public function device(?Tournament $tournament, ?Area $area): static
   {
