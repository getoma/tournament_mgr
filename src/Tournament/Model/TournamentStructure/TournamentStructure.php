...
class TournamentStructure
{
   ...
   /** @var MatchParticipantCollection of all participants that don't have a start place right now */
   public MatchParticipantCollection $unmapped_participants;
   ...
   /**
    * extract the pool id from a slot name - pool slot naming is defined by MatchParticipantHandler
    */
