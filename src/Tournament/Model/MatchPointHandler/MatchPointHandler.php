...
interface MatchPointHandler
{
    ...
    */
   function addPoint(SoloMatchRecord $match, MatchPoint $pt): bool;

   /**
    * Remove point, and do any needed other rollback action
    * @param SoloMatchRecord $match - the match to remove the point from
    ...
    */
   function getWinner(SoloMatchRecord $match): ?Participant;
    ...
    */
   function isDecided(SoloMatchRecord $match): bool;
    ...
    */
   function getActivePenalties(SoloMatchRecord $match): MatchPointCollection;

   /**
    * extract real, actual points
    */
   function getPoints(SoloMatchRecord $match): MatchPointCollection;
